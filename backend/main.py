...
# Import admin profile endpoints and register router
import admin_profile_endpoints
app.include_router(admin_profile_endpoints.router)
...
async def log_meal_suggestion(user_id: str, meal_type: str, suggestion: str, context: dict):
    ...
    try:
        suggestion_log = {
            "id": f"meal_suggestion_{user_id}_{datetime.utcnow().isoformat()}",
