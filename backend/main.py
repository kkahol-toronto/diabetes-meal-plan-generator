...
async def send_chat_message(
    ...
    system_prompt = f"""You are an advanced AI Diet Coach and Diabetes Management Specialist..."""  # Default prompt (abbreviated for edit)
    ...
    # The user's current message is already in formatted_chat_history
